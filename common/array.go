...
//// 取多个数组或切片的差集
//func ArrayDiff(args ...interface{}) interface{} {
//	var result interface{}
//	argLen := len(args)
//
//	for i := 0; i < argLen; i++ {
//		arr1 := reflect.TypeOf(args[i])
//		for ai := 0; ai < arr1.NumField(); ai++ {
//			found := false
//			// 判断iv是否在别的数组中
//			for j := 0; j < argLen; j++ {
//				if j == i {
//					continue
//				}
//				arr2 := reflect.TypeOf(args[j])
//				for aj := 0; aj < arr2.NumField(); aj++ {
//					if reflect.ValueOf(arr2.Field(aj)) == reflect.ValueOf(arr1.Field(ai)) {
//						found = true
//						break
//					}
//				}
...
//
//			if !found {
//				result = append(result, arr1.Field(ai))
//			}
//		}
//	}
//
